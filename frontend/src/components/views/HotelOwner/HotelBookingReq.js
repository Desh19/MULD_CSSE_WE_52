  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 dashContainer">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Hotel Booking Request</h1>
      </div>
      ...
      <div className='hotelsRatingContainer grid-container'>
        ...
        <div class="card hotelRatingItem grid-item">
              ...
              <div className='row mb-2'>
                  <div class="col-md-12">
                        <button type='button' class='btn btn-success btn-sm' data-bs-toggle="modal" data-bs-target="#staticBackdrop">View Request</button>
                  </div>
              </div> 
              <span>
...
{/* <!-- Modal --> */}
<div class="modal fade mt-3" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modalSize">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title " id="staticBackdropLabel">Hotel Name</h5>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Reject</button>
...
export default HotelBookingReq